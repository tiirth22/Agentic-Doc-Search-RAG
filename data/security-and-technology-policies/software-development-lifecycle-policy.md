...
Test data used throughout the development process is subject to GitLab's [Data Classification Standard](/handbook/security/policies_and_standards/data-classification-standard/) (SA-3(2))

## Standard

For further details, please review GitLab's [Software Development Lifecycle Standard](/handbook/security/policies_and_standards/software-development-lifecycle-standard).
